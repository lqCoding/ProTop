 ...
 */
public class ToolsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener, BaseQuickAdapter.OnRecyclerViewItemClickListener {
    ...
    private void initView(View view) {
        ...
        //初始化recycleView
        recyclerView= (RecyclerView) view.findViewById(R.id.tools_recycler_view);
        // 设置固定大小
    ...
    public void onResume() {
        ...
        try{
            list=biz.getNewsFromDB("tb_tools");
            if(list.size()<=1){
    ...
    public void onRefresh() {
        ...
        for(int i =0;i<=count;i++){
            ...
            biz.getNewsFromNetNew("拓展资源",temp[0], temp[1],temp[2], new RefreshListener() {
                @Override
    ...
    public void onItemClick(View view, int i) {
       ...
       /* try{
            //更新数据库的阅读状态
            int num= biz.updateRead("tb_tools", list.get(i).getUrl());
