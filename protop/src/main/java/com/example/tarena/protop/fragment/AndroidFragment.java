 ...
 */
public class AndroidFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,BaseQuickAdapter.OnRecyclerViewItemClickListener {
    ...
    private void initView(View view) {
        ...
        //初始化recycleView
        recyclerView= (RecyclerView) view.findViewById( R.id.android_recycler_view);
        // 设置固定大小
    ...
    public void onResume() {
        ...
        try{
            list=biz.getNewsFromDB("tb_android");
            if(list.size()<=1){
                ...
                //添加头部这句话必须要设 要不不居中
              //if(!header.getLayoutParams().equals(params)) {
    ...
    public void onRefresh() {
        ...
        for(int i =0;i<=count;i++){
            ...
            biz.getNewsFromNetNew("Android",temp[0], temp[1],temp[2], new RefreshListener() {
                @Override
                    ...
                    if(nlist!=null) {
                        ...
                        for (News n : nlist) {
                            if(Long.valueOf(n.getPublishedAt())> finalListTime){
                                ...
                                biz.addRefreshToDB("tb_android", n);
                            }
                        }
    ...
    public void onItemClick(View view, int i) {
      ...
      /*  try{
            //更新数据库的阅读状态
            int num= biz.updateRead("tb_android", list.get(i).getUrl());
