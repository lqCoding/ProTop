 ...
 */
public class IosFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener, BaseQuickAdapter.OnRecyclerViewItemClickListener {
    ...
    private void initView(View view) {
        ...
        //初始化recycleView
        recyclerView= (RecyclerView) view.findViewById( R.id.ios_recycler_view);
        // 设置固定大小
    ...
    public void onRefresh() {
        ...
        for(int i =0;i<=count;i++){
            ...
            biz.getNewsFromNetNew("iOS",temp[0], temp[1],temp[2], new RefreshListener() {
                @Override
    ...
    public void onItemClick(View view, int i) {
       ...
       /* try{
            //更新数据库的阅读状态
            int num= biz.updateRead("tb_ios", list.get(i).getUrl());
